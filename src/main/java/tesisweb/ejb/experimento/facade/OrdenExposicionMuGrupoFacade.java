 ...
 */
@Stateless
public class OrdenExposicionMuGrupoFacade extends AbstractFacade<OrdenExposicionMuGrupo> {
    ...
    public OrdenExposicionMuGrupoFacade() {
        super(OrdenExposicionMuGrupo.class);
    }
