...
public class JSFutil implements Serializable {
    ...
    private static final String folderImagen = "/tesisapp/images/";
    ...
    public static String getFolderImagen() {
        return folderImagen;
    }
    ...
    public static ResourceBundle getMyBundle() {
        ResourceBundle bundle = ResourceBundle.getBundle("tesisweb.properties.bundle", getmyLocale());
        return bundle;
    }
